          ...
          <div className="mx-auto max-w-6xl px-5 py-20 md:py-24">
            <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              ...
              >
                ...
                <h2 className="mt-4 text-3xl font-bold tracking-tight text-[var(--ink)] sm:text-4xl">
                  Carpet repair service for Denver and surrounding areas.
                </h2>
                <p className="mt-5 text-lg leading-8 text-[var(--muted)]">
                  Untouchable Carpet Repair primarily serves Denver, Colorado,
                  with availability in nearby communities depending on schedule
                  and project location.
                </p>
                <p className="mt-5 text-base font-semibold leading-7 text-[var(--ink)]">
                  Call or text to confirm availability for your address.
                </p>
              </div>
              ...
              >
                <div className="relative overflow-hidden rounded-[1.5rem] border border-[var(--line)] bg-white/72">
                  ...
                  <div className="relative aspect-[4/3] min-h-[280px] p-6 sm:aspect-[16/9] md:p-8">
                    ...
                    <div className="relative flex h-full flex-col justify-between">
                      <div className="max-w-sm rounded-[1.25rem] border border-white/70 bg-white/82 p-5 shadow-sm backdrop-blur-md">
                        ...
                        <p className="mt-3 text-sm leading-6 text-[var(--muted)]">
                          A static service-area map will be added here after
                          Google Maps API setup is approved.
                        </p>
                      </div>
